<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y bg-white" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="<?= base_url('landingpage') ?>" target="_blank">
            <img src="<?= base_url('assets/'); ?>img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">Website Ekstrakurikuler</span>
        </a>
    </div>
    ...
    <ul class="navbar-nav">
        ...
        <?php foreach ($menu as $m) : ?>
           ...
           ";
            ...
            <?php foreach ($subMenu as $sm) : ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo ($title == $sm['title']) ? 'active' : ''; ?>" href="<?= base_url($sm['url']); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#">
                ...
                <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" class="nav-link-text ms-1">Keluar</button>
            </a>
        </li>
    </ul>
</aside>