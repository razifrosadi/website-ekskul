            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Ekstrakurikuler Wajib</a>
                            </h5>
                            <p class="mb-0">
                ...
                <div class="col-lg-4 col-md-6 my-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Ekstrakurikuler Olahraga</a>
                            </h5>
                            <p class="mb-0">
                                Website visitors today demand a frictionless user expericence — especially when using search. Because of the hight standards.
                            </p>
                ...
                <div class="col-lg-4 col-md-6 my-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Ekstrakurikuler Bahasa</a>
                            </h5>
                            <p class="mb-0">
                                Website visitors today demand a frictionless user expericence — especially when using search. Because of the hight standards.
                            </p>
                ...
                <div class="col-lg-4 col-md-6 my-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Ekstrakurikuler Teknologi</a>
                            </h5>
                            <p class="mb-0">
                                Website visitors today demand a frictionless user expericence — especially when using search. Because of the hight standards.
                            </p>
                ...
                <div class="col-lg-4 col-md-6 my-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Ekstrakurikuler Seni</a>
                            </h5>
                            <p class="mb-0">
                                Website visitors today demand a frictionless user expericence — especially when using search. Because of the hight standards.
                            </p>
                ...
                <div class="col-lg-4 col-md-6 my-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Ekstrakurikuler Keagamaan</a>
                            </h5>
                            <p class="mb-0">
                                Website visitors today demand a frictionless user expericence — especially when using search. Because of the hight standards.
                            </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-6 col-12 my-auto">
                                <div class="card-body ps-lg-0">
                                    ...
                                    <h6 class="text-primary">Athlete</h6>
                                    <p class="mb-0">Artist is a term applied to a person who engages in an activity deemed to be an art.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-6 col-12 my-auto">
                                <div class="card-body ps-lg-0">
                                    ...
                                    <h6 class="text-primary">JS Developer</h6>
                                    <p class="mb-0">Artist is a term applied to a person who engages in an activity deemed to be an art.</p>
                                </div>
                            </div>
                        </div>
