            ...
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <p class="text-xs font-weight-bold mb-0">Judul Informasi</p>
                        </td>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">Deskripsi Informasi</p>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="author align-items-center">
                                <img src="assets/img/bg.jpg" alt="..." class="avatar shadow">
                                <div class="name ps-3">
                        </td>
...
<div class="modal fade" id="newInformasiModal" tabindex="-1" role="dialog" aria-labelledby="newInformasiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('ketua/informasi'); ?>" method="post">
                <div class="modal-body">
                    <div class="row">

                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" id="nama_ekskul" name="nama_ekskul" placeholder="Judul Informasi">
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="nama_ekskul" name="nama_ekskul" placeholder="Deskripsi Informasi">
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="file" class="form-control" id="logo_ekskul" name="logo_ekskul" placeholder="Gambar">
                                </div>
                            </div>
                        </div>
                    </div>
