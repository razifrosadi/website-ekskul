                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group input-group-static mb-4">
                                                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?php echo $user['name']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group col-md-6 ps-md-2">
                                            <select class="form-select <?php echo form_error('kelas') ? 'is-invalid' : ''; ?>" name="kelas">
