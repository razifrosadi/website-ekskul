...
--
-- Host: localhost
-- Generation Time: Jul 04, 2023 at 06:15 PM
...
INSERT INTO `siswa` (`id_siswa`, `nama_lengkap`, `no_wa`, `kelas_id`, `ekskul_id`, `alasan`) VALUES
(2, 'dwi fahriza', '08123456', NULL, NULL, '2020.022323');

-- --------------------------------------------------------

--
-- Table structure for table `tambah_informasi`
--
...
--
-- Dumping data for table `tambah_informasi`
--
...
--
-- Indexes for table `kategori_ekskul`
--
...
--
-- Indexes for table `tambah_informasi`
--
...
--
-- AUTO_INCREMENT for table `kategori_ekskul`
--
ALTER TABLE `kategori_ekskul`
...
--
-- AUTO_INCREMENT for table `tambah_informasi`
--
ALTER TABLE `tambah_informasi`
